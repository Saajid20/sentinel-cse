...
_ALIAS_MAP: dict[str, str] = {
    ...
    "profit loss before tax": "profit_before_income_tax",
    "profit loss before income tax": "profit_before_income_tax",
    "income tax expense": "income_tax_expense",
    "profit for the period": "profit_for_the_period",
    "profit loss for the period": "profit_for_the_period",
    "profit loss for the year": "profit_for_the_period",
    "profit loss for the quarter": "profit_for_the_period",
